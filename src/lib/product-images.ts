...
export const LOCAL_IMAGES: Record<string, string> = {
  ...
  "Bacon Attack": baconAttackImg,
  "Wings Nature Classic": wingsNatureNew,
  "Wings Firestorm": wingsFirestorm,
  "Wings Smoky BBQ": wingsSmokyBbq,
  ...
  "Sauce Ranch": mayonnaiseImg,
  "Sauce Korean Spicy": sauceKorean,
  "Sauce African Verde": sauceVerde,
  "Sauce Algérienne": sauceSpicy,
  "Ketchup": ketchupImg,
  "Mayonnaise": ranchImg,
  "Box A · Combo Solo": boxAImg,
  "Box B · Combo Express": boxBImg,
  "Box C · Crazy Box": boxCImg,
  "Box D · Discovery Box": boxDImg,
  "Eau (50cl)": eauImg,
  "Soda (33cl)": sodaImg,
  "Citronnade Maison": citronnadeImg,
  "Thé glacé pêche": theGlaceImg,
  "Milkshake Classic": milkshakeClassic,
  "Milkshake Speculoos Dream": milkshakeSpeculoos,
  "Milkshake Caramel Beurre Salé": milkshakeCaramel,
  "Cookie Noisette Chocolat Maison": cookieNoisetteChocolat,
