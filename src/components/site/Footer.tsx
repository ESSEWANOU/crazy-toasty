  ...
  return (
    <footer className="relative border-t border-border pb-12 overflow-hidden">
      ...
      <div className="relative w-full flex justify-center items-center py-8 md:py-12 px-4 bg-[#1e3a8a] overflow-hidden">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[50vw] max-w-[800px] aspect-square bg-primary/25 blur-3xl rounded-full pointer-events-none" aria-hidden />
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#commander" className="hover:text-primary transition-colors">Commander</a></li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a href="#" aria-label="Instagram" className="h-11 w-11 rounded-xl bg-card grid place-items-center hover:bg-primary hover:text-primary-foreground transition-colors"><Instagram className="h-5 w-5" /></a>
              <a href="#" aria-label="Facebook" className="h-11 w-11 rounded-xl bg-card grid place-items-center hover:bg-primary hover:text-primary-foreground transition-colors"><Facebook className="h-5 w-5" /></a>
              <a href="#" aria-label="TikTok" className="h-11 w-11 rounded-xl bg-card grid place-items-center hover:bg-primary hover:text-primary-foreground transition-colors font-display">TT</a>
            </div>
      ...
      <div className="container mx-auto px-4">
        <div className="pt-6 border-t border-border text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} Crazy Toasty · Toulous'hein. Tous droits réservés. Made with 🔥 in Toulouse.
        </div>
      </div>
    </footer>
  );
